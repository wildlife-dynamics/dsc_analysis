...
IO_TASKS_IMPORTABLE_REFERENCES = [
    "ecoscope_workflows_ext_distance_sample_counts.tasks.fetch_patrol_events",
    "ecoscope_workflows_ext_distance_sample_counts.tasks.fetch_transects",
    "ecoscope_workflows_ext_distance_sample_counts.tasks.fetch_events",
